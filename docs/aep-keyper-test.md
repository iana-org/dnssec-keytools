...
Run test cases to create Python virtualenv. Some tests will likely fail because of too old SoftHSM2 in Debian/Ubuntu. 
...
(Note: This should not be required if once activate the venv or install ksr-signer as a wheel/package)
