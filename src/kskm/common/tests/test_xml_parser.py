...
class TestXMLParser(unittest.TestCase):
    ...
    def test_basic_xml_parser(self):
        ...
        xml = '''
                ...
                '''
        parsed = parse(xml)
        expected = {'KSR': {'attrs': {'id': '46E2A89A-91A4-11DE-9606-D3C665893CB7',
                                      'domain': '.'
                                      },
                            'value': {'Request':
                                          {'RequestPolicy':
    ...
    def test_multiple_bundles(self):
        ...
        xml = '''
                ...
                '''
        parsed = parse(xml)
        expected = {'KSR': {'Request':
                                {'RequestBundle': [{'attrs': {'id': '46E2E616-91A4-11DE-AC37-E3B2CDA0AB07'},
    ...
    def test_signer(self):
        ...
        xml = '''
                ...
                '''
        parsed = parse(xml)
        expected = {'KSR': {'Signer': [{'attrs': {'keyIdentifier': 'KC00020'}, 'value': ''},
    ...
    def test_nested_tags(self):
        ...
        parsed = parse(xml)
        expected = {'KSR': {'Signature': {'attrs': {'keyIdentifier': 'ZSK-24315'},
                                          'value': {'KeyTag': '24315',
                                                    'Signature': 'WL7ks0TL...',
                                                    }
                                          }
