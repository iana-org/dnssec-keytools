...
class Test_signers_from_list(TestCase):
    ...
    def test_basic(self):
        ...
        data = [{'attrs': {'keyIdentifier': 'KC00020'}, 'value': ''},
                {'attrs': {'keyIdentifier': 'KC00094'}, 'value': ''},
                ]
        out = signers_from_list(data)
        self.assertEqual(out, {Signer(key_identifier='KC00020'),
                               Signer(key_identifier='KC00094'),
                               }
                         )
...
class Test_keys_from_list(TestCase):
    ...
    def test_basic(self):
        ...
        data = [{'attrs': {'keyIdentifier': 'ZSK-24315', 'keyTag': '24315'},
                 'value': {'Algorithm': '5',
                           'Flags': '256',
                           'Protocol': '3',
                           'PublicKey': 'A...',
        ...
        expected = {Key(key_identifier='ZSK-24315',
                        key_tag=24315,
                        ttl=1978,
                        flags=256,
                        protocol=3,
    ...
    def test_ecdsa_key(self):
        ...
        data = [{'attrs': {'keyIdentifier': 'EC1', 'keyTag': '0'},
                 'value': {'Algorithm': AlgorithmDNSSEC.ECDSAP256SHA256.value,
                           'Flags': '256',
                           'Protocol': '3',
        ...
        out = keys_from_dict(data)
        expected = {Key(key_identifier='EC1',
                        key_tag=0,
                        ttl=1978,
                        flags=256,
                        protocol=3,
...
class Test_signature_from_dict(TestCase):
    ...
    def test_basic(self):
        ...
        sig = {'attrs': {'keyIdentifier': 'ZSK-24315'},
               'value': {'Algorithm': '5',
                         'KeyTag': '24315',
                         'Labels': '0',
                         'OriginalTTL': '3600',
        ...
        expected = {Signature(key_identifier='ZSK-24315',
                              ttl=1234,
                              type_covered=TypeDNSSEC.DNSKEY,
                              algorithm=AlgorithmDNSSEC.RSASHA1,
                              labels=0,
                              original_ttl=3600,
                              signature_expiration=datetime.datetime(2009, 9, 24, 18, 22, 41, tzinfo=utc),
                              signature_inception=datetime.datetime(2009, 8, 25, 18, 22, 41, tzinfo=utc),
                              key_tag=24315,
                              signers_name='.',
